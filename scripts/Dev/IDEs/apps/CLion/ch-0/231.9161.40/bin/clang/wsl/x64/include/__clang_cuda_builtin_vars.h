...
#define __cuda_builtin_threadIdx_t uint3
#define __cuda_builtin_blockIdx_t uint3
#define __cuda_builtin_blockDim_t dim3
#define __cuda_builtin_gridDim_t dim3
